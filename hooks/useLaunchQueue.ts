 ...
 * file (via the manifest's `file_handlers` entry), we receive the file
 * here, parse it as a vCard, and surface the picker through the returned
 * state.
 *
 * The caller renders the ContactPickerSheet bound to `pending` and clears
